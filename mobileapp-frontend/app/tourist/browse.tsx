        ...
        {loading ? (
          ...
          <View style={s.grid}>
            {filteredArtists.map((artist: any, idx: number) => {
              ...
              return (
                <TouchableOpacity key={artist._id || idx} style={s.card} activeOpacity={0.9}>
                  {pic ? (
...
const s = StyleSheet.create({
  ...
  searchContainer: { backgroundColor: '#fff', paddingHorizontal: 16, paddingBottom: 16, borderBottomWidth: 1, borderBottomColor: '#F0F0F0' },
  searchBar: {
